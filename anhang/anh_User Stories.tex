...
\hline
\textbf{US-SP-006} & \textbf{Als Stadtplanerin} möchte ich für explorative Beteiligungsarten einstellen können, \textbf{wie strikt} das System die Einhaltung von Regeln prüft. & 1. Einstellbares \verb|Kreativitäts-Level| ist implementiert.2. Auswahl zwischen keiner Prüfung, nur Durchsetzung geometrischer Constraints (Spielmodus), nur Warnung bei Verstoß, strikte Fehler bei Verstoß. \\
\hline\hline
