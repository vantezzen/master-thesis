...
Auf Basis der ermittelten Stakeholder wurde eine Stakeholder-Tabelle mit Hauptinteressen, Erwartungen, Einfluss und potenziellen Konflikten aufgestellt, welche in Tabelle \ref{tab:Stakeholder-Tabelle} [S. \pageref{tab:Stakeholder-Tabelle}, Anhang] abgebildet ist.
...
Aufbauend auf den erarbeiteten Informationen zu Stakeholdern wurden User Stories definiert. Die vollständige Tabelle aller User Stories ist in Tabelle \ref{tab:User Stories} [S. \pageref{tab:User Stories}, Anhang] abgebildet. Die Stories wurden hierfür für jede Stakeholdergruppe einzeln definiert und folgen dem Schema „US-\textit{Stakeholdergruppe}-\textit{Nummer}“, z.B. \textit{US-SP-005}, für die spätere Referenzierung.
...
Zur besseren Gruppierung und Überblick zu wichtigen Funktionen wurde anschließend eine Use Case Tabelle ausgearbeitet. Diese ist als Tabelle \ref{tab:Use Cases} [S. \pageref{tab:Use Cases}, Anhang] abgebildet. Die einzelnen Use Cases werden zudem in den Tabellen \ref{tab:UC-VAL-001} [S. \pageref{tab:UC-VAL-001}] bis \ref{tab:UC-DEV-001} [S. \pageref{tab:UC-DEV-001}] genauer untersucht. Die Use Cases referenzieren hierbei jeweils diejenigen User Stories, welche sie zusammenfassen.
...
Die Tabelle aller Systemanforderungen ist als Tabelle \ref{tab:Systemanforderungen} [S. \pageref{tab:Systemanforderungen}, Anhang] zu finden.
