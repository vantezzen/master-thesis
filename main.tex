...
\addbibresource{bibliography/fpa.bib}
\addbibresource{bibliography/fpb.bib}
...
\DeclareRobustCommand{\textmono}[1]{%
  \begingroup
    \sethlcolor{light-gray}%  Hintergrund für \hl festlegen
    \texttt{\hl{#1}}%       Monospace + graues Highlight
  \endgroup
}

% custom "quoted" command
\newcommand*{\quoted}[1]{%
  \glqq{}#1\grqq{}%
}
...
\input{content/40 Konzeptualisierung von Constraints}
\newpage

\input{content/50 Konzeptualisierung eines Constraint-Systems}
\newpage
